...
5. **Check the neighbors.** Follow the page's links one hop out. Any page repeating the losing claim gets the same treatment in this session.
...
- **Reconcile**: zero-trust-networking
...
- **Update**: concepts/microsegmentation.md
```
