...
3. **Read the candidate pages fully**, then follow wikilinks one hop out for context.
...
```
## [2026-04-10] query | "How do sessions survive an auth-api deploy?"
- filed as: queries/session-survival-on-deploy.md
- pages read: 6 (auth README + 5)
```
