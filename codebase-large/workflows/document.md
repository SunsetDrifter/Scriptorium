...
4. **Discuss before writing.** Tell the human what you found, what you'll file, and where in the subsystem hierarchy. Confirm `criticality` and `verification_method` with them. If the pass will create concept or synthesis pages, apply the page-worthiness test at the end of this file and say so in the plan.
