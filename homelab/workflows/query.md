...
2. **Read the candidate pages fully**, then follow wikilinks one hop out for context (components to their topology pages, incidents to their runbooks).
...
```
## [2026-04-10] query | "What breaks if proxmox-01 goes down?"
- filed as: queries/proxmox-01-blast-radius.md
- pages read: 6
```
