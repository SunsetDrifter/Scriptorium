...
3. **Link every component involved** with markdown links. Add the incident to each affected component page's "Incidents" section and bump those pages' `updated`.
...
- **Incident**: grafana down 45min
- **Filed**: incidents/2026-04-10-grafana-oom.md
- **Update**: components/grafana.md, components/proxmox-01.md
- **Runbook**: runbooks/grafana-oom-recovery.md
```
